...
# include <pthread.h>
# include <sys/time.h>
# define filasA 600		/* Cantidad de filas de la matriz A */
# define columnasB 600		/* Cantidad de columnas de la matriz A = Cantidad de filas de la matriz B */
# define comunAB 600		/* Cantidad de columnas de la matriz B */
