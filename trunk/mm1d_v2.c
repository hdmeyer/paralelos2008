...
# include <pthread.h>
# include <sys/time.h>
# define filasA 4000		/* Cantidad de filas de la matriz A */
# define columnasB 4000		/* Cantidad de columnas de la matriz A = Cantidad de filas de la matriz B */
# define comunAB 4000		/* Cantidad de columnas de la matriz B */
